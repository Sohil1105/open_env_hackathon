...
start = content.find("def get_underwriting_explanation")
end = content.find("def calculate_dynamic_ground_truth", start)
...
if start != -1 and end != -1:
    content = content[:start] + new_explanation_func + "\n\n" + content[end:]
